  ...
  return(
    ...
    <div id="wholepage">
        ...
        {this.state.dataAction.map(action=>(
          <div className="smaller" key={Math.random()}>
          <a href={action.url}>
          ...
          <ul className="categories"><h4 className="lefth">All Categories</h4>
            <li><a href="#">Home & Living</a></li>
          ...
          <div className="priceitem">
            ...
            <span id="highlow">
              <input type="text" id="low" placeholder="Low" /> to <input type="text" id="high" placeholder="high" /><button type="arrow"></button></span>
           </div>
           <div className="colored">
    		  ...
    		  <ul className="ordering"><h4 className="lefth">Ordering Options</h4>
      ...
      <footer>
        <ul><h4>Turn your passion into a business</h4>
        ...
        <ul><h4>Discover and shop</h4>
          <li><a href="#">Gift cards</a></li>
          <li><a href="#">Blog</a></li>
          <li><a href="#">Mobile apps</a></li>
          <li><a href="#">Gift registeries</a></li>
